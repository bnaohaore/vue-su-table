               ...
               <su-table-sync ref="suTableSyncFef" :tableData.sync="su_tableData">
                   <template slot-scope="scope">
                       <su-table-menban ref="menban1">
                           <su-table ref='menban1SuTableRef' @rowClick='menban1_rowclick' :tableData="menban_table">
                       ...
                       >
                           ...
                           <su-table-column  label='普通input' >
                               <template slot-scope="scope">
                                   <su-table-edit :disabled='true' @openEdit="openEdit" @confirm="inputConfirm" @editValueChange="inputchanges" :col="scope.$colIndex" :row="scope.$rowIndex" layer="input" v-model="scope.row.name" ></su-table-edit>
                               </template>
                           </su-table-column>
